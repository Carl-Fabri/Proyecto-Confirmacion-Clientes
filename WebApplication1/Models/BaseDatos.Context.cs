...
namespace WebApplication1.Models
{
    ...
    public partial class NorthwindEntidad : DbContext
    {
        public NorthwindEntidad()
            : base("name=NorthwindEntidad")
        {
        }
        ...
        public virtual ObjectResult<SP_MOSTRARORDENES_Result> SP_MOSTRARORDENES()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_MOSTRARORDENES_Result>("SP_MOSTRARORDENES");
        }
        ...
        public virtual ObjectResult<SP_MOSTRAPRODUCTOS_Result> SP_MOSTRAPRODUCTOS(Nullable<int> orderListId)
        {
            var orderListIdParameter = orderListId.HasValue ?
                new ObjectParameter("OrderListId", orderListId) :
                new ObjectParameter("OrderListId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_MOSTRAPRODUCTOS_Result>("SP_MOSTRAPRODUCTOS", orderListIdParameter);
        }
    }
}
